            ...
            >
              <div className="flex flex-col p-3 w-full rounded bg-muted md:p-4">
                <div className="flex justify-between items-baseline pl-2 mb-10">
                  <p className="text-2xl font-semibold">메뉴</p>
                  <Button size="sm" variant="ghost" aria-label="Close menu" onClick={closeMobileMenu}>
                    닫기
                  </Button>
                </div>
                ...
                <ShopLinks label="제품 카테고리" collections={collections} />

                <div className="mt-auto mb-6 text-sm leading-tight opacity-50">
                  <p className="italic">시공 및 견적 문의</p>
                  <div className="mt-5">
                    <p className="text-2xl font-semibold">{businessInfo.tel}</p>
